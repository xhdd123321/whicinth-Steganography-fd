...
const data = [
  {
    label: '加密-图片',
    value: '实现将图片数据加密进图片中, 载体图片仅支持PNG/JPG/JPEG，单文件限制10M，加密公共CD:10s',
  },
  {
    label: '加密-文字',
    value: '实现将文字数据加密进图片中, 文字长度限制为500，单文件限制10M，加密公共CD:10s',
  },
  {
    label: '解密-图片',
    value: '实现从图片中解密图片数据, 结果文件格式为PNG，单文件限制30M，解密公共CD:10s',
  },
  {
    label: '解密-文字',
    value: '实现从图片中解密文字数据, 文字长度限制为5000，单文件限制30M，解密公共CD:10s',
  },
  {
    label: '解密-智能',
    value: '实现从图片中智能识别是否存在图片或文字隐写, 并根据识别结果进行解密，单文件限制30M，解密公共CD:10s',
  },
  {
    label: '风信',
